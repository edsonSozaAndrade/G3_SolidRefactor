...
public class GildedRoseTest {
  ...
  public void testNormalItemDecrementQuality() {
    ...
    int inputQuality = 20;
    Item item = new RegularItem("+5 Dexterity Vest", 10, inputQuality);
  ...
  public void testNormalItemDoubleDecrementQuality() {
    GildedRose.items = new ArrayList<>();
    int inputQuality = 20;
    Item item = new RegularItem("+5 Dexterity Vest", 0, inputQuality);
  ...
  public void testItemSufurasLegendary() {
    GildedRose.items = new ArrayList<>();
    int inputQuality = 80;
    Item item = new LegendaryItem("Sulfuras, Hand of Ragnaros", 15, inputQuality);
  ...
  public void testItemNoGreaterThan50() {
    GildedRose.items = new ArrayList<>();
    int inputQuality = 50;
    Item item = new InverseQualityItem("Aged Brie", 20, inputQuality);
  ...
  public void testbackstageIncrementsQuality() {
    GildedRose.items = new ArrayList<>();
    int inputQuality = 20;
    Item item = new InverseQualityItem("Backstage passes to a TAFKAL80ETC concert", 15, inputQuality);
  ...
  public void testbackstageDoubleIncrementQuality() {
    GildedRose.items = new ArrayList<>();
    int inputQuality = 20;
    Item item = new InverseQualityItem("Backstage passes to a TAFKAL80ETC concert", 10, inputQuality);
  ...
  public void testBackstageTripleIncrementQuality() {
    GildedRose.items = new ArrayList<>();
    int inputQuality = 20;
    Item item = new InverseQualityItem("Backstage passes to a TAFKAL80ETC concert", 5, inputQuality);
  ...
  public void testBackstageZeroQuality() {
    GildedRose.items = new ArrayList<>();
    int inputQuality = 20;
    Item item = new InverseQualityItem("Backstage passes to a TAFKAL80ETC concert", 0, inputQuality);
